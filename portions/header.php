...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
             ...
             <a href="index.php" class="<?php echo $_SERVER['REQUEST_URI']=== '/lshipromo/index.php' ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white";?> rounded-md px-3 py-2 text-sm font-medium">
                Accueil</a>
              <a href="magasins.php" class="<?php echo $_SERVER['REQUEST_URI']=== '/lshipromo/magasins.php' ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white";?> rounded-md px-3 py-2 text-sm font-medium">
                Magasins</a>
                <a href="publier.php" class="<?php echo $_SERVER['REQUEST_URI']=== '/shipromo/publier.php' ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white";?> rounded-md px-3 py-2 text-sm font-medium">
                Publier
            </a>
              <a href="contact.php" class="<?php echo $_SERVER['REQUEST_URI']=== '/shipromo/contact.php' ? "bg-gray-950/50 text-white" : "text-gray-300 hover:bg-white/5 hover:text-white";?> rounded-md px-3 py-2 text-sm font-medium">
                Contact
            </a>
            </div>
          </div>
  ...
  <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-white/10">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-white"> <?php echo $header; ?></h1>
