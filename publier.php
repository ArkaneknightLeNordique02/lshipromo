...
<form class="max-w-sm mx-auto" methode="POST" action="controllers/creer_offre.php" enctype="multipart/form_data.php" >
  <div class="mb-5">
  ...
  <div class="mb-5">
    ...
    <div class="mb-5">
        ...
        <select id="Devise" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            <option value="US">FC</option>
    ...
    <div class="mb-5">
        ...
        <select id="Magasin" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
